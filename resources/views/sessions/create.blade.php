...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" novalidate method="POST" action="{{ route('session.store', $event->id) }}">
                @csrf
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="inputTitle" name="title" placeholder="" value="title">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="inputSpeaker" name="speaker" placeholder="" value="speaker">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="textareaDescription" name="description" placeholder="" rows="5">Description</textarea>
                    </div>
                </div>
