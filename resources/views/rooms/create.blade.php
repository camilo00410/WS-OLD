...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" novalidate method="POST" action="{{ route('room.store', $event->id) }}">
                @csrf
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="inputCapacity" name="capacity" placeholder="" value="100">
                    </div>
                </div>
